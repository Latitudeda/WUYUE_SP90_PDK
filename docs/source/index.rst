...
This documentation outlines the contents and usage of the **Latitudeda PDK** for **WUYUE SP90** (v0.6).

The PDK is compatible with **PhotoCAD** and **Advanced SDL** for layout generation. Key features and capabilities include:

- Designing custom components using the defined layers from **WUYUE SP90**.
- Creating circuits with **WUYUE**'s predefined components and **Latitudeda**'s base PCell.
